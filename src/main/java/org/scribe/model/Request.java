...
public class Request {
	...
	public String toString() {
		return "Request [url=" + url + ", verb=" + verb
				+ ", querystringParams=" + querystringParams + ", bodyParams="
				+ bodyParams + ", headers=" + headers + ", payload=" + payload
				+ ", connection=" + connection + ", charset=" + charset
				+ ", bytePayload=" + Arrays.toString(bytePayload)
				+ ", connectionKeepAlive=" + connectionKeepAlive
				+ ", followRedirects=" + followRedirects + ", connectTimeout="
